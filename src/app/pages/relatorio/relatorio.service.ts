...
import { filtroItens, filtroEstoque } from 'src/app/shared/models/tabela';
...
export class RelatorioService {
	...
	getEstoque(filtros: filtroEstoque, paginacao: PageEvent) {
		const url = `${this.url}/acompanhamento/estoque`;
